...
즉, **중요한 것은 대부분 긴급하지 않고, 긴급한 것은 대체로 중요하지 않다는 점**입니다.
장애를 두 가지 기준으로 나누어 볼 수 있습니다.
...
심각도를 처음부터 너무 상세하게 구분할 필요는 없으며, 크게 서비스 이용에 치명적인 장애를 주는 것과 그렇지 않은 것으로 나누어 생각하면 됩니다. “치명적”의 의미는 서비스마다 다를 수 있지만 대개 아래에 해당합니다.
...
각종 시스템 리소스 및 하드웨어 상태는 필수 모니터링 대상입니다. 모니터링 툴을 설치해보면 측정해주는 항목들이 너무 많아서 당황스러운 경험을 하게 되는데요. 아래는 저희가 주목하고 있는 항목들입니다.
