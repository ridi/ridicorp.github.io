...
이제 log 라는 별명을 통해 전체 기간의 로그데이터를 단일 색인인 것 처럼 사용할 수 있게 되었습니다. 오늘의 로그 데이터는 log-today 라는 별명을 붙여줍니다. 이렇게 조금만 응용하면 필요에 따라 오늘의 로그, 최근 일주일 간의 로그, 최근 한 달 간의 로그 등등의 별명을 얼마든지 붙여두고 사용할 수 있습니다.
